...
import { type LS_KEYS } from './local-storage.js';
...
export declare function mutationFactory<T extends Record<string, any> & {
    uid: string;
}>(entityMap: Partial<Record<string, T>>, mutationMap: Partial<Record<string, Mutation<T>>>, localStorageKey?: ValueOf<typeof LS_KEYS> | false, maxNumberRecords?: number): {
