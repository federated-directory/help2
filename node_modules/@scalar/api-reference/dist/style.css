...
.property-example[data-v-72def0ea] {
  display: flex;
  flex-direction: column;
  font-size: var(--scalar-mini);
  position: relative;
}
.property-example[data-v-72def0ea]:hover:before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
...
.property-example:hover .property-example-label span[data-v-72def0ea] {
  color: var(--scalar-color-1);
}
.property-example-label span[data-v-72def0ea] {
  color: var(--scalar-color-3);
  position: relative;
  border-bottom: var(--scalar-border-width) dotted currentColor;
}
.property-example-value[data-v-72def0ea] {
  font-family: var(--scalar-font-code);
  display: flex;
  gap: 8px;
  align-items: center;
...
.property-example-value span[data-v-72def0ea] {
  display: block;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}
.property-example-value[data-v-72def0ea] svg {
  color: var(--scalar-color-3);
}
.property-example-value[data-v-72def0ea]:hover svg {
  color: var(--scalar-color-1);
}
.property-example-value[data-v-72def0ea] {
  background: var(--scalar-background-2);
...
.property-example-value-list[data-v-72def0ea] {
  position: absolute;
  top: 18px;
  left: 50%;
...
.property-example:hover .property-example-value-list[data-v-72def0ea],
.property-example:focus-within .property-example-value-list[data-v-72def0ea] {
  display: flex;
}
...
.parameter-item[data-v-c5dd25f2] {
  display: flex;
  flex-direction: column;
  position: relative;
  border-top: var(--scalar-border-width) solid var(--scalar-border-color);
}
.parameter-item:last-of-type .parameter-schema[data-v-c5dd25f2] {
  padding-bottom: 0;
}
.parameter-item-container[data-v-c5dd25f2] {
  padding: 0;
}
.parameter-item-headers[data-v-c5dd25f2] {
  border: var(--scalar-border-width) solid var(--scalar-border-color);
}
.parameter-item-name[data-v-c5dd25f2] {
  position: relative;
  font-weight: var(--scalar-semibold);
  font-size: var(--scalar-font-size-3);
  font-family: var(--scalar-font-code);
...
.parameter-item-description[data-v-c5dd25f2],
.parameter-item-description-summary[data-v-c5dd25f2] {
  font-size: var(--scalar-mini);
  color: var(--scalar-color-2);
}
.parameter-item-description-summary.parameter-item-description-summary[data-v-c5dd25f2] > * {
...
.parameter-item-required-optional[data-v-c5dd25f2] {
  color: var(--scalar-color-2);
  font-weight: var(--scalar-semibold);
  margin-right: 6px;
  position: relative;
}
.parameter-item--required[data-v-c5dd25f2] {
  text-transform: uppercase;
  font-size: var(--scalar-micro);
  font-weight: var(--scalar-semibold);
  color: var(--scalar-color-orange);
...
.parameter-item-description[data-v-c5dd25f2] p {
  margin-top: 4px;
  font-size: var(--scalar-small);
  color: var(--scalar-color-2);
  line-height: 1.4;
}
.parameter-schema[data-v-c5dd25f2] {
  padding-bottom: 9px;
  margin-top: 3px;
}
.parameter-item-trigger[data-v-c5dd25f2] {
  display: flex;
  align-items: baseline;
...
.parameter-item-trigger-open[data-v-c5dd25f2] {
  padding-bottom: 0;
}
.parameter-item-icon[data-v-c5dd25f2] {
  color: var(--scalar-color-3);
  left: -19px;
  top: 0.5lh;
  translate: 0 -50%;
...
.parameter-item-trigger:hover .parameter-item-icon[data-v-c5dd25f2],
.parameter-item-trigger:focus-visible .parameter-item-icon[data-v-c5dd25f2] {
  color: var(--scalar-color-1);
}
.parameter-item-trigger:focus-visible .parameter-item-icon[data-v-c5dd25f2] {
...
.callback-sticky-offset[data-v-102d2096] {
  top: var(--refs-viewport-offset, 0px);
  z-index: 1;
}
.callback-operation-container[data-v-102d2096] .request-body,
.callback-operation-container[data-v-102d2096] .request-body-description,
.callback-operation-container[data-v-102d2096] .request-body-header {
  margin-top: 0;
}
.callback-operation-container[data-v-102d2096] .request-body-header {
...
.callback-operation-container[data-v-102d2096]
  .request-body-schema > .schema-card > .schema-card-description {
  padding-inline: 8px;
}
.callback-operation-container[data-v-102d2096] ul li.property.property--level-1 {
  padding: 8px;
}
.callback-operation-container[data-v-102d2096] .request-body-schema {
  background-color: var(--scalar-background-1);
  border: var(--scalar-border-width) solid var(--scalar-border-color);
  border-top: none;
  overflow: hidden;
...
.callback-operation-container[data-v-102d2096] .parameter-list {
  margin-top: 0;
}
.callback-operation-container[data-v-102d2096] .parameter-list-title {
  background: color-mix(in srgb, var(--scalar-background-2) 50%, transparent);
  border-radius: var(--scalar-radius-lg) var(--scalar-radius-lg) 0 0;
  padding: 8px;
  margin-bottom: 0;
...
.callback-operation-container[data-v-102d2096] .parameter-list-items {
  /* background: pink; */
  border: var(--scalar-border-width) solid var(--scalar-border-color);
  border-radius: 0 0 var(--scalar-radius-lg) var(--scalar-radius-lg);
}
.callback-operation-container[data-v-102d2096] .parameter-list-items > li:first-of-type {
  border-top: none;
}
.callback-operation-container[data-v-102d2096] .parameter-list-items > li {
  padding: 0 8px;
}

.empty-state[data-v-ab9ce344] {
...
.rule[data-v-ab9ce344] {
  margin: 0 12px 0;
  border-radius: var(--scalar-radius-lg);
}
.rule-items[data-v-ab9ce344] {
...
.rule-item[data-v-ab9ce344]:before {
...
.response-card[data-v-8ea26797] {
  font-size: var(--scalar-font-size-3);
}
.markdown[data-v-8ea26797] * {
  margin: 0;
}
.code-copy[data-v-8ea26797] {
  display: flex;
  align-items: center;
  justify-content: center;
  appearance: none;
...
.code-copy[data-v-8ea26797]:hover {
  color: var(--scalar-color-1);
}
.code-copy svg[data-v-8ea26797] {
  width: 13px;
  height: 13px;
}
.response-card-footer[data-v-8ea26797] {
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  flex-shrink: 0;
...
.response-example-selector[data-v-8ea26797] {
  align-self: flex-start;
  margin: -4px;
}
.response-description[data-v-8ea26797] {
  font-weight: var(--scalar-semibold);
  font-size: var(--scalar-small);
  color: var(--scalar-color--1);
...
.schema-example[data-v-8ea26797] {
  font-size: var(--scalar-micro);
  color: var(--scalar-color-2);
  font-weight: var(--scalar-semibold);
}
.example-response-tab[data-v-8ea26797] {
  display: block;
  margin: 6px;
}
.scalar-card-checkbox[data-v-8ea26797] {
  display: flex;
  align-items: center;
  justify-content: center;
  position: relative;
...
.scalar-card-checkbox:has(.scalar-card-checkbox-input:focus-visible)
  .scalar-card-checkbox-checkmark[data-v-8ea26797] {
  outline: 1px solid var(--scalar-color-accent);
}
.scalar-card-checkbox[data-v-8ea26797]:hover {
  color: var(--scalar-color--1);
}
.scalar-card-checkbox .scalar-card-checkbox-input[data-v-8ea26797] {
  position: absolute;
  opacity: 0;
  cursor: pointer;
  height: 0;
...
.scalar-card-checkbox[data-v-8ea26797]:has(.scalar-card-checkbox-input:checked) {
  color: var(--scalar-color-1);
  font-weight: var(--scalar-semibold);
}
...
.scalar-card-checkbox-checkmark[data-v-8ea26797]:after {
  content: '';
  position: absolute;
  display: none;
}
...
.scalar-card-checkbox .scalar-card-checkbox-checkmark[data-v-8ea26797]:after {
  right: 11.5px;
  top: 12.5px;
  width: 5px;
  height: 9px;
...
.show-api-client-button[data-v-e851edeb] {
  appearance: none;
  border: none;
  padding: 1px 6px;
  white-space: nowrap;
...
.show-api-client-button span[data-v-e851edeb],
.show-api-client-button svg[data-v-e851edeb] {
  fill: currentColor;
  color: var(--scalar-button-1-color);
  z-index: 1;
}
.show-api-client-button[data-v-e851edeb]:hover {
...
.client-libraries-content[data-v-6a49c111] {
...
.client-libraries[data-v-6a49c111] {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 100%;
...
.client-libraries[data-v-6a49c111]:not(.client-libraries__active):hover:before {
  content: '';
  position: absolute;
  width: calc(100% - 4px);
  height: calc(100% - 4px);
...
.client-libraries[data-v-6a49c111]:active {
  color: var(--scalar-color-1);
}
.client-libraries[data-v-6a49c111]:focus-visible {
  outline: none;
  box-shadow: inset 0 0 0 1px var(--scalar-color-accent);
}
/* remove php and c on mobile */
@media screen and (max-width: 450px) {
.client-libraries[data-v-6a49c111]:nth-of-type(4),
  .client-libraries[data-v-6a49c111]:nth-of-type(5) {
    display: none;
}
}
.client-libraries-icon[data-v-6a49c111] {
  max-width: 14px;
  max-height: 14px;
  min-width: 14px;
  width: 100%;
...
.client-libraries-icon__more svg[data-v-6a49c111] {
  height: initial;
}
...
.client-libraries-icon__more + span[data-v-6a49c111] {
      display: none;
}
}
}
...
.client-libraries span[data-v-6a49c111] {
    display: none;
}
}
.client-libraries__active[data-v-6a49c111] {
  color: var(--scalar-color-1);
  border-bottom: 1px solid var(--scalar-color-1);
}
@keyframes codeloader-6a49c111 {
0% {
...
.client-libraries .client-libraries-text[data-v-6a49c111] {
  font-size: var(--scalar-small);
  position: relative;
  display: flex;
  align-items: center;
}
.client-libraries__active .client-libraries-text[data-v-6a49c111] {
  color: var(--scalar-color-1);
  font-weight: var(--scalar-semibold);
}
@media screen and (max-width: 600px) {
.references-classic .client-libraries[data-v-6a49c111] {
    flex-direction: column;
}
}

.selected-client[data-v-e59e2ca0] {
  color: var(--scalar-color-1);
  font-size: var(--scalar-small);
  font-family: var(--scalar-font-code);
  padding: 9px 12px;
...
.client-libraries-heading[data-v-e59e2ca0] {
  font-size: var(--scalar-small);
...
[data-v-e59e2ca0] .scalar-codeblock-pre .hljs {
  margin-top: 8px;
}
...
.scalar-app .top-\[calc\(14px\+0\.5lh\)\] {
  top: calc(14px + .5lh);
}
.scalar-app .-left-4\.5 {
  left: -18px;
...
.scalar-app .group-hover\:opacity-100:is(:where(.group):hover *), .scalar-app .group-hover\/heading\:opacity-100:is(:where(.group\/heading):hover *), .scalar-app .group-hover\/parameter-item\:opacity-100:is(:where(.group\/parameter-item):hover *) {
    opacity: 1;
}
}
...
.open-api-client-button[data-v-c7bdd328]:hover {
...
[data-v-c1a50a6e] .cm-editor {
  padding: 0;
}
[data-v-c1a50a6e] .cm-content {
  font-family: var(--scalar-font);
  font-size: var(--scalar-small);
  background-color: #0000;
  align-items: center;
...
[data-v-c1a50a6e] .cm-content:has(.cm-pill) {
  padding: 5px 8px;
}
[data-v-c1a50a6e] .cm-content .cm-pill:not(:last-of-type) {
  margin-right: .5px;
}
[data-v-c1a50a6e] .cm-content .cm-pill:not(:first-of-type) {
  margin-left: .5px;
}
[data-v-c1a50a6e] .cm-line {
  text-overflow: ellipsis;
  word-break: break-word;
  padding: 0;
  overflow: hidden;
}
.required[data-v-c1a50a6e]:after {
  content: "Required";
}
input[data-v-c1a50a6e]::placeholder {
  color: var(--scalar-color-3);
}
.scalar-password-input[data-v-c1a50a6e] {
  text-security: disc;
...
.scalar-collection-auth[data-v-dc159f6f] {
  border: var(--scalar-border-width) solid var(--scalar-border-color);
  border-radius: var(--scalar-radius-lg);
  overflow: hidden;
}
...
.scalar .scalar-app-layout[data-v-b54530a3] {
  background: var(--scalar-background-1);
  opacity: 0;
  border: var(--scalar-border-width) solid var(--scalar-border-color);
  border-radius: 8px;
  ...
  height: calc(100% - 120px);
  margin: auto;
  animation: .35s forwards scalarapiclientfadein-b54530a3;
  position: relative;
  overflow: hidden;
}
@media (max-width: 720px) and (max-height: 480px) {
...
@keyframes scalarapiclientfadein-b54530a3 {
0% {
    opacity: 0;
}
to {
...
.scalar .scalar-app-exit[data-v-b54530a3] {
  cursor: pointer;
  z-index: -1;
  background: #00000038;
  width: 100vw;
  height: 100vh;
  transition: all .3s ease-in-out;
  animation: .35s forwards scalardrawerexitfadein-b54530a3;
  position: fixed;
  top: 0;
  left: 0;
}
.dark-mode .scalar .scalar-app-exit[data-v-b54530a3] {
  background: #00000073;
}
.scalar .scalar-app-exit[data-v-b54530a3]:before {
  text-align: center;
  color: #fff;
  opacity: .6;
  font-family: sans-serif;
...
.scalar .scalar-app-exit[data-v-b54530a3]:hover:before {
  opacity: 1;
}
@keyframes scalardrawerexitfadein-b54530a3 {
0% {
    opacity: 0;
}
to {
...
.scalar-container[data-v-b54530a3] {
  visibility: visible;
  z-index: 10000;
  justify-content: center;
  align-items: center;
...
.scalar .url-form-input[data-v-b54530a3] {
  min-height: auto !important;
}
.scalar .scalar-container[data-v-b54530a3] {
  line-height: normal;
}
.scalar .scalar-app-header span[data-v-b54530a3] {
  color: var(--scalar-color-3);
}
.scalar .scalar-app-header a[data-v-b54530a3] {
  color: var(--scalar-color-1);
}
.scalar .scalar-app-header a[data-v-b54530a3]:hover {
  text-decoration: underline;
}
.scalar-activate[data-v-b54530a3] {
  cursor: pointer;
  align-items: center;
  gap: 6px;
  width: fit-content;
...
.scalar-activate-button[data-v-b54530a3] {
  color: var(--scalar-color-blue);
  appearance: none;
  background: none;
  border: none;
...
.scalar-activate:hover .scalar-activate-button[data-v-b54530a3] {
  background: var(--scalar-background-3);
  border-radius: 3px;
}
