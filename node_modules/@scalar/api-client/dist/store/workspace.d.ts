...
export declare const createWorkspaceStore: (router: Router, persistData?: boolean) => {
    ...
    importSpecFile: (_spec: string | AnyObject, workspaceUid?: string, overloadServers?: Spec["servers"]) => Promise<void>;
    ...
    environmentMutators: {
        ...
        edit: <P extends "color" | "name" | "uid" | "raw" | "parsed" | "isDefault" | `parsed.${number}` | `parsed.${number}.value` | `parsed.${number}.key`>(uid: string, path: P, value: P extends "color" | "name" | "uid" | "raw" | "parsed" | "isDefault" ? {
            ...
            isDefault?: boolean | undefined;
        }[P] : P extends `${infer K}.${infer R}` ? K extends "color" | "name" | "uid" | "raw" | "parsed" | "isDefault" ? R extends Path<{
            uid: string;
            name: string;
            color: string;
            raw: string;
    ...
    folderMutators: {
        ...
        edit: <P extends "description" | "name" | "uid" | "childUids" | `childUids.${number}`>(uid: string, path: P, value: P extends "description" | "name" | "uid" | "childUids" ? {
            ...
            childUids: string[];
            description?: string | undefined;
        }[P] : P extends `${infer K}.${infer R}` ? K extends "description" | "name" | "uid" | "childUids" ? R extends Path<{
            uid: string;
            name: string;
            childUids: string[];
            description?: string | undefined;
    ...
    securitySchemeMutators: {
        ...
        edit: <P extends "value" | "type" | "description" | "name" | "uid" | "in" | "secondValue" | "flow" | "nameKey" | "scheme" | "bearerFormat" | "clientId" | "openIdConnectUrl" | "flow.selectedScopes" | "flow.type" | "flow.redirectUri" | "flow.token" | "flow.refreshUrl" | "flow.authorizationUrl" | "flow.scopes" | `flow.selectedScopes.${number}` | `flow.scopes.${string}` | "flow.value" | "flow.clientSecret" | "flow.secondValue" | "flow.tokenUrl">(uid: string, path: P, value: (P extends "value" | "type" | "description" | "name" | "uid" | "in" | "nameKey" ? {
            ...
            secondValue: string;
            description?: string | undefined;
        }[P] : P extends `${infer K}.${infer R}` ? K extends "value" | "type" | "description" | "uid" | "secondValue" | "nameKey" | "scheme" | "bearerFormat" ? R extends Path<{
            type: "http";
            value: string;
            uid: string;
            nameKey: string;
            ...
            clientId: string;
            description?: string | undefined;
        }[P] : P extends `${infer K}.${infer R}` ? K extends "type" | "description" | "uid" | "flow" | "nameKey" | "clientId" ? R extends Path<{
            type: "oauth2";
            uid: string;
            nameKey: string;
            flow: {
            ...
            openIdConnectUrl: string;
            description?: string | undefined;
        }[P] : P extends `${infer K}.${infer R}` ? K extends "type" | "description" | "uid" | "nameKey" | "openIdConnectUrl" ? R extends Path<{
            type: "openIdConnect";
            uid: string;
            nameKey: string;
            openIdConnectUrl: string;
    ...
    serverMutators: {
        ...
        }[P] : P extends `${infer K}.${infer R}` ? K extends "url" | "description" | "variables" | "uid" ? R extends Path<{
            uid: string;
            url: string;
            description?: string | undefined;
            variables?: Record<string, {
