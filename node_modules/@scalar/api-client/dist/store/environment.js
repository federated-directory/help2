import { LS_KEYS as o } from "@scalar/helpers/object/local-storage";
import { environmentSchema as a } from "@scalar/oas-utils/entities/environment";
import { mutationFactory as m } from "@scalar/object-utils/mutator-record";
import { reactive as r } from "vue";
function f(n) {
  const t = r({}), e = m(t, r({}), n && o.ENVIRONMENT);
  return e.add(
    a.parse({
      uid: "default",
