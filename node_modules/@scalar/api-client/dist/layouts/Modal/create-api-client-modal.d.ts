 ...
 */
export declare const createApiClientModal: (el: HTMLElement | null, configuration?: ClientConfiguration, mountOnInitialize?: boolean) => Promise<{
    ...
    store: {
        ...
        cookieMutators: {
            ...
            edit: <P extends "value" | "path" | "name" | "uid" | "domain" | "expires" | "secure" | "httpOnly" | "sameSite" | "maxAge" | "partitioned">(uid: string, path: P, value: P extends "value" | "path" | "name" | "uid" | "domain" | "expires" | "secure" | "httpOnly" | "sameSite" | "maxAge" | "partitioned" ? {
                ...
                partitioned?: boolean | undefined;
                secure?: boolean | undefined;
            }[P] : P extends `${infer K}.${infer R}` ? K extends "value" | "path" | "name" | "uid" | "domain" | "expires" | "secure" | "httpOnly" | "sameSite" | "maxAge" | "partitioned" ? R extends import("@scalar/object-utils/nested").Path<{
                value: string;
                uid: string;
                name: string;
                sameSite: "Lax" | "Strict" | "None";
        ...
        collectionMutators: {
            ...
            edit: <P extends "uid" | "childUids" | `childUids.${number}` | "spec" | "securitySchemeDict" | "selectedServerUid" | "spec.info.title" | "spec.openapi" | "spec.info" | "spec.security" | "spec.tags" | "spec.externalDocs" | `spec.security.${number}` | `spec.security.${number}.${string}` | `spec.tags.${number}` | "spec.externalDocs.url" | "spec.externalDocs.description" | "spec.serverUids" | "spec.info.summary" | "spec.info.description" | "spec.info.termsOfService" | "spec.info.contact" | "spec.info.license" | "spec.info.version" | "spec.info.contact.email" | "spec.info.contact.url" | "spec.info.contact.name" | "spec.info.license.url" | "spec.info.license.name" | "spec.info.license.identifier" | `spec.tags.${number}.description` | `spec.tags.${number}.externalDocs` | `spec.tags.${number}.name` | `spec.tags.${number}.externalDocs.url` | `spec.tags.${number}.externalDocs.description` | `spec.serverUids.${number}` | `securitySchemeDict.${string}`>(uid: string, path: P, value: P extends "uid" | "childUids" | "spec" | "securitySchemeDict" | "selectedServerUid" ? {
                ...
                selectedServerUid: string;
                childUids: string[];
            }[P] : P extends `${infer K}.${infer R}` ? K extends "uid" | "childUids" | "spec" | "securitySchemeDict" | "selectedServerUid" ? R extends import("@scalar/object-utils/nested").Path<{
                uid: string;
                spec: {
                    openapi: string;
                    security: Record<string, string[]>[];
        ...
        environmentMutators: {
            ...
            edit: <P extends "color" | "name" | "uid" | "raw" | "parsed" | "isDefault" | `parsed.${number}` | `parsed.${number}.value` | `parsed.${number}.key`>(uid: string, path: P, value: P extends "color" | "name" | "uid" | "raw" | "parsed" | "isDefault" ? {
                uid: string;
                name: string;
                color: string;
                raw: string;
            ...
            untrackedEdit: <P extends "color" | "name" | "uid" | "raw" | "parsed" | "isDefault" | `parsed.${number}` | `parsed.${number}.value` | `parsed.${number}.key`>(uid: string, path: P, value: P extends "color" | "name" | "uid" | "raw" | "parsed" | "isDefault" ? {
                uid: string;
                name: string;
                color: string;
                raw: string;
        ...
        folderMutators: {
            ...
            edit: <P extends "description" | "name" | "uid" | "childUids" | `childUids.${number}`>(uid: string, path: P, value: P extends "description" | "name" | "uid" | "childUids" ? {
                uid: string;
                name: string;
                childUids: string[];
                description?: string | undefined;
            ...
            untrackedEdit: <P extends "description" | "name" | "uid" | "childUids" | `childUids.${number}`>(uid: string, path: P, value: P extends "description" | "name" | "uid" | "childUids" ? {
                uid: string;
                name: string;
                childUids: string[];
                description?: string | undefined;
        ...
        securitySchemeMutators: {
            ...
            edit: <P extends "value" | "type" | "description" | "name" | "uid" | "in" | "secondValue" | "flow" | "nameKey" | "scheme" | "bearerFormat" | "clientId" | "openIdConnectUrl" | "flow.selectedScopes" | "flow.type" | "flow.redirectUri" | "flow.token" | "flow.refreshUrl" | "flow.authorizationUrl" | "flow.scopes" | `flow.selectedScopes.${number}` | `flow.scopes.${string}` | "flow.value" | "flow.clientSecret" | "flow.secondValue" | "flow.tokenUrl">(uid: string, path: P, value: (P extends "value" | "type" | "description" | "name" | "uid" | "in" | "nameKey" ? {
                ...
                secondValue: string;
                description?: string | undefined;
            }[P] : P extends `${infer K}.${infer R}` ? K extends "value" | "type" | "description" | "uid" | "secondValue" | "nameKey" | "scheme" | "bearerFormat" ? R extends import("@scalar/object-utils/nested").Path<{
                type: "http";
                value: string;
                uid: string;
                nameKey: string;
                ...
                secondValue: string;
                description?: string | undefined;
            }[K], R> : never : K extends `${number}` ? never : never : P extends `${number}` ? never : never) | (P extends "type" | "description" | "uid" | "flow" | "nameKey" | "clientId" ? {
                type: "oauth2";
                uid: string;
                nameKey: string;
                flow: {
                ...
                clientId: string;
                description?: string | undefined;
            }[P] : P extends `${infer K}.${infer R}` ? K extends "type" | "description" | "uid" | "flow" | "nameKey" | "clientId" ? R extends import("@scalar/object-utils/nested").Path<{
                type: "oauth2";
                uid: string;
                nameKey: string;
                flow: {
        ...
        serverMutators: {
            ...
            edit: <P extends "url" | "description" | "variables" | "uid" | `variables.${string}`>(uid: string, path: P, value: P extends "url" | "description" | "variables" | "uid" ? {
                uid: string;
                url: string;
                description?: string | undefined;
                variables?: Record<string, {
            ...
            }[P] : P extends `${infer K}.${infer R}` ? K extends "url" | "description" | "variables" | "uid" ? R extends import("@scalar/object-utils/nested").Path<{
                uid: string;
                url: string;
                description?: string | undefined;
                variables?: Record<string, {
            ...
            untrackedEdit: <P extends "url" | "description" | "variables" | "uid" | `variables.${string}`>(uid: string, path: P, value: P extends "url" | "description" | "variables" | "uid" ? {
                uid: string;
                url: string;
                description?: string | undefined;
                variables?: Record<string, {
 ...
 */
export declare const createApiClientModalSync: (el: HTMLElement | null, configuration?: ClientConfiguration, mountOnInitialize?: boolean) => {
    app: import("vue").App<Element>;
    updateConfig(newConfig: ClientConfiguration, mergeConfigs?: boolean): void;
    updateServerUrl: (serverUrl: string) => void;
    updateAuth: (auth: import("@scalar/types/legacy").AuthenticationState) => void;
