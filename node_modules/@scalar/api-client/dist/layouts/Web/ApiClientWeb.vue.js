...
import { handleHotKeyDown as N } from "../../libs/hot-keys.js";
import P from "../../components/ImportCollection/ImportCollectionListener.vue.js";
const W = ["innerHTML"], Z = /* @__PURE__ */ f({
  __name: "ApiClientWeb",
  setup($) {
    x();
    const { activeWorkspace: a } = b(), { events: t } = A();
    _(() => T());
    const s = (e) => N(e, t.hotKeys), l = (e) => {
