...
} & XScalarSecretClientId & XScalarSecretToken & XScalarSecurityQuery & XScalarSecurityBody & XTokenName;
...
export type OAuthFlowPassword = OAuthFlowCommon & {
    /** REQUIRED. The token URL to be used for this flow. This MUST be in the form of a URL. The OAuth2 standard requires the use of TLS. */
    tokenUrl: string;
} & XScalarSecretHTTP & XScalarSecretClientSecret & XScalarCredentialsLocation;
...
export type OAuthFlowClientCredentials = OAuthFlowCommon & {
    /** REQUIRED. The token URL to be used for this flow. This MUST be in the form of a URL. The OAuth2 standard requires the use of TLS. */
    tokenUrl: string;
} & XScalarSecretClientSecret & XScalarCredentialsLocation;
...
export type OAuthFlowAuthorizationCode = OAuthFlowCommon & {
    ...
    /** REQUIRED. The token URL to be used for this flow. This MUST be in the form of a URL. The OAuth2 standard requires the use of TLS. */
    tokenUrl: string;
} & XScalarSecretClientSecret & XScalarSecretRedirectUri & XusePkce & XScalarCredentialsLocation;
